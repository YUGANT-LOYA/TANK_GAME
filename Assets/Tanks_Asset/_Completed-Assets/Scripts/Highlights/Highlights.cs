...
namespace NVIDIA {	
	public class Highlights {
...
#else
        #error x86 builds not supported, all pointers are harded coded as 64bits.
#endif
        ...
        public static void DefaultLogListener(LogLevel level, string message)
        {
            ...
            Debug.Log("Highlights LogListener " + levelString[(int)level] + ": " + message);
        }
        ...
        public static void DefaultGetNumberOfHighlightsCallback(ReturnCode ret, int number, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("GetNumberOfHighlightsCallback " + id + " returns " + number);
            }
            else
            {
                Debug.LogError("GetNumberOfHighlightsCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultGetUserSettingsCallback(ReturnCode ret, UserSettings settings, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("GetUserSettingsCallback " + id + " returns table count " + settings.highlightSettingTable.Count);
                foreach (var setting in settings.highlightSettingTable)
                {
                    Debug.Log("GetUserSettingsCallback " + id + " " + setting.id + " "  + setting.enabled);
                }
            }
            else
            {
                Debug.LogError("GetUserSettingsCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultGetUILanguageCallback(ReturnCode ret, string langueage, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("GetUILanguageCallback " + id + " returns " + langueage);
            }
            else
            {
                Debug.LogError("GetUILanguageCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultRequestPermissionsCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("RequestPermissionsCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("RequestPermissionsCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultConfigureCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("ConfigureCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("ConfigureCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultSetScreenshotCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("SetScreenshotCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("SetScreenshotCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultSetVideoCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("SetVideoCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("SetVideoCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultOpenSummaryCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("OpenSummaryCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("OpenSummaryCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultOpenGroupCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("OpenGroupCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("OpenGroupCallback " + id + " returns unsuccess");
            }
        }
        ...
        public static void DefaultCloseGroupCallback(ReturnCode ret, int id)
        {
            if (ret == ReturnCode.SUCCESS)
            {
                Debug.Log("CloseGroupCallback " + id + " returns success");
            }
            else
            {
                Debug.LogError("CloseGroupCallback " + id + " returns unsuccess");
            }
        }
